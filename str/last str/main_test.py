...
#     contours, hierarchy = cv2.findContours(thresh_img, # на выходк выходной массив контуров  иерархий
#                                 cv2.RETR_TREE,
#                                 cv2.CHAIN_APPROX_SIMPLE) #оставляет только крайние точки а не контуры
...
# contours, hierarchy = find_contours(image_gray)
